...
public class mylawyer extends AppCompatActivity {
                ...
                email.setOnClickListener(new View.OnClickListener() {
                    ...
                    public void onClick(View v) {
                        ...
                        try {
                            ...
                            Toast.makeText(mylawyer.this, "There are no email clients installed.", Toast.LENGTH_SHORT).show();
                        }
                    }
                });
            ...
            public void onClick(View v) {
                ...
                zonesRef.addListenerForSingleValueEvent(new ValueEventListener() {
                    ...
                    public void onDataChange(DataSnapshot dataSnapshot) {
                        ...
                        {
                            String total_case = dataSnapshot.child("total_case").getValue().toString();
                            String all_case[] = total_case.split(";");
                            String new_total ="";
                            for(String case1 : all_case)
                            {
                                if(case1 != currentUser.getUid())
                                    new_total = new_total+";"+case1;

                            }
                            if(new_total==" "||new_total==""||new_total==";")
                                zonesRef.child("total_case").removeValue();
                            else
