...
public class getimage extends AppCompatActivity {
    ...
    FloatingActionButton uploadBtn,galleryBtn;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        uploadBtn.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                final StorageReference PicRef = mStorageRef.child("Profile_Pic/"+currentuser.getUid()+".jpg");
                PicRef.putFile(contentUri)
                        ...
                        .addOnFailureListener(new OnFailureListener() {
                            ...
                            public void onFailure(@NonNull Exception exception) {
                                Toast.makeText(getimage.this,"Upload Failed: "+exception.toString(),Toast.LENGTH_LONG).show();
                            }
                        });
                if(flag)
                {
