...
public class UploadFile extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        Intent i = getIntent();
        folder = i.getStringExtra("uid");

        StorageReference master = mStorageRef.child("Case_Docs/"+folder);
        master.listAll()
        ...
        switch (requestCode) {
            case FILE_SELECT_CODE:
                if (resultCode == RESULT_OK) {
                    ...
                    StorageReference upload = mStorageRef.child("Case_Docs/"+folder+"/"+displayName);
                    upload.putFile(uri)
